...
from uuids_fake import uuids_amendes, uuids_paypal, uuids_atandt, uuids_amazon, uuids_netflix, uuids_ameli, \
    uuids_credit_agricole, uuids_microsoft, uuids_luxtrust, uuids_orange, uuids_other_phishing

lookyloo = Lookyloo()

if lookyloo.is_up:
    #name of the institution so that we do not have to change the paths in the code
    institution = "other_phishing"

    #need to change the uuid list manually
    for uuid in uuids_other_phishing:
